## Purpose
Defines how published articles are turned into Facebook Page posts: a live WordPress URL and feature image gate eligibility, the post body is a length-tiered plain-text excerpt with a randomized CTA, the post itself carries the article's feature image, and a follow-up comment links back to the WordPress article.
