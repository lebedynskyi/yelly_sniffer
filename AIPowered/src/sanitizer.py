...
class Bs4HtmlSanitizer:
    def sanitize_html(self, html: str) -> str:
        logger.info("🛁Sanitization of article")
        clean = self.clean_html(html)

        # remove CTA text like subscribe / like and etc
        ...
        while changed:
            ...
            for tag in soup.find_all(BLOCK_TAGS):
                # Keep tags with images or embeds
        ...
        return self.clean_html(soup.prettify())
